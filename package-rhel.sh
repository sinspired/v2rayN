...
xray_url_for_rid() {
  ...
  case "$rid" in
    linux-x64)   echo "https://github.com/sinspired/Xray-core/releases/download/v${ver}/Xray-linux-64.zip" ;;
    linux-arm64) echo "https://github.com/sinspired/Xray-core/releases/download/v${ver}/Xray-linux-arm64-v8a.zip" ;;
    *)           return 1 ;;
  esac
}
...
download_xray() {
  ...
  if [[ -z "$ver" ]]; then
    ver="$(curl -fsSL https://api.github.com/repos/sinspired/Xray-core/releases/latest \
